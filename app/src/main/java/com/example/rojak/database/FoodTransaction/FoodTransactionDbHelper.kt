    ...
    companion object {
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE ${FoodTransactionContract.FoodTransactionEntry.TABLE_NAME} (" +
                    "${FoodTransactionContract.FoodTransactionEntry.COLUMN_NAME_ID} SERIAL PRIMARY KEY," +
                    "${FoodTransactionContract.FoodTransactionEntry.COLUMN_NAME_FOOD_ID} INTEGER," +
